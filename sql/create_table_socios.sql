...
ALTER TABLE LABDATABASE. DROP CONSTRAINT PLANOS_SOCIOS_FK;
ALTER TABLE LABDATABASE. DROP CONSTRAINT PLANO_MENSALIDADE_FK;
ALTER TABLE LABDATABASE. DROP CONSTRAINT SOCIOS_MENSALIDADES_FK;
